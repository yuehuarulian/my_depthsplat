...
from .dataset_arkit_scenes import DatasetARKitScenes, DatasetARKitScenesCfg
...
DATASETS: dict[str, Dataset] = {
    "re10k": DatasetRE10k,
    "dl3dv": DatasetDL3DV,
    "arkit_scenes": DatasetARKitScenes,
}


DatasetCfg = DatasetRE10kCfg | DatasetDL3DVCfg | DatasetARKitScenesCfg
