...
from .dataset_scannet_plus import DatasetScannetPlus, DatasetScannetPlusCfg
...
DATASETS: dict[str, Dataset] = {
    "re10k": DatasetRE10k,
    "dl3dv": DatasetDL3DV,
    "scannet_plus": DatasetScannetPlus,
}


DatasetCfg = DatasetRE10kCfg | DatasetDL3DVCfg | DatasetScannetPlusCfg
